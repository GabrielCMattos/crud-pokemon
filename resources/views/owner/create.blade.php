...
<div class="w-full max-w-xs mx-auto flex items-center justify-center min-h-screen ">
  <form class="bg-white shadow-md rounded px-20 pb-8 mb-4" action="{{ url('owner') }}" method="POST" enctype="multipart/form-data">
  ...
  @csrf
    ...
    <div class="flex items-center justify-center">
      <a href="/owner"><button class=" shadow appearance-none bg-amber-400 hover:scale-110 font-bold py-2 px-4 mt-3 rounded focus:outline-none focus:shadow-outline" type="button">
        All Owners
      </button>
      </a>
    </div>
